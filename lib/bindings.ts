...
export interface NobleBindingsInterface {
  ...
  on(event: 'includedServicesDiscover', listener: (peripheralUuid: string, serviceUuid: string, includedServiceUuids: string[]) => void): this;
  on(event: 'characteristicsDiscover', listener: (peripheralUuid: string, serviceUuid: string, characteristics: Characteristic[]) => void): this;
  on(event: 'read', listener: (peripheralUuid: string, serviceUuid: string, characteristicUuid: string, data: Buffer, isNotification: boolean) => void): this;
  ...
  on(event: 'descriptorsDiscover', listener: (peripheralUuid: string, serviceUuid: string, characteristicUuid: string, descriptorUuids: string[]) => void): this;
  on(event: 'valueRead', listener: (peripheralUuid: string, serviceUuid: string, characteristicUuid: string, descriptorUuid: string, data: Buffer) => void): this;
  on(event: 'valueWrite', listener: (peripheralUuid: string, serviceUuid: string, characteristicUuid: string, descriptorUuid: string) => void): this;
